...
{
// EMSCRIPTEN: don't need need most of those..	
	switch ( get_be32( header ) )
	{
		case BLARGG_4CHAR('Z','X','A','Y'):  return "AY";	// spectreZX is probably better 
//		case BLARGG_4CHAR('G','B','S',0x01): return "GBS";	use webNEZ
		case BLARGG_4CHAR('G','Y','M','X'):  return "GYM";
//		case BLARGG_4CHAR('H','E','S','M'):  return "HES";	use webNEZ or webTurbo
//		case BLARGG_4CHAR('K','S','C','C'):
//		case BLARGG_4CHAR('K','S','S','X'):  return "KSS";	use webNEZ
//		case BLARGG_4CHAR('N','E','S','M'):  return "NSF";	use webNEZ
//		case BLARGG_4CHAR('N','S','F','E'):  return "NSFE";	use webNEZ
//		case BLARGG_4CHAR('S','A','P',0x0D): return "SAP";	use webASAP
		case BLARGG_4CHAR('S','N','E','S'):  return "SPC";
//		case BLARGG_4CHAR('V','g','m',' '):  return "VGM";	use webVGM
	}
